    ...
    if validate_location_for_search(latlong):
        ...
        for latlong in n_sunset_spots:
            ...
            if len(image_urls) > 0:
                ...
                # create a dictionary where the key is latlong nd the values are the 
                # correspodnign urls
                final_urls[str(latlong)] = image_urls

        print "HEY YALL I'M A DICTIONARY"
        print final_urls
